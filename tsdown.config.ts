/**
 * dsh-omnisearch — tsdown build for the browser client bundle.
 *
 ...
 *   package-name id (`dsh-omnisearch`; client-modules compose keys on the
...
export default [
  // Official profile channel: bundle id = package name (package.json `name`).
  {
    ...
    outputOptions: {
      ...
      banner: `window.__ModuleLoader__.load({ id: "dsh-omnisearch", factory: (require) => {`,
