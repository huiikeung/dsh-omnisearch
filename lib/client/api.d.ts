...
export declare const api: {
    ...
    platformImportCookies: (platform: BrowserPlatform, cookies: string) => Promise<{
        saved: number;
        platform: string;
    }>;
    vncStart: (platform: BrowserPlatform) => Promise<{
        ok: boolean;
        platform: string;
        token?: string;
        error?: string;
    }>;
    vncStop: (platform: BrowserPlatform) => Promise<{
        ok: true;
    }>;
