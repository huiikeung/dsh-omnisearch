...
export declare const PROVIDER_ID = "dsh-omnisearch";
...
export declare function describeAttempt(outcome: string): string | undefined;
/**
 ...
 */
export declare function buildSearchNote(opts: {
    serving: string;
    preferred: string;
    attempts: Array<{
        provider: string;
