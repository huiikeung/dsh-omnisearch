...
export interface SourceSearchOutcome {
    ...
    /**
     * Model-facing prose from the general web path — in dsh-omnisearch this carries
     * the fallback `Note:` line explaining which engine actually served the
     * results (merged from dsh-free-search). Platform-native outcomes omit it.
     */
    content?: string;
}
