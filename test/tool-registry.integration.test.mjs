...
/** The exact config dsh-omnisearch' patch now sets on the host tool-web row. */
...
async function buildRoot() {
  ...
  root.web.registerSearchProvider(stubSearchProvider("dsh-omnisearch"));
  root.web.registerFetchProvider(stubFetchProvider("dsh-omnisearch-fetch"));
